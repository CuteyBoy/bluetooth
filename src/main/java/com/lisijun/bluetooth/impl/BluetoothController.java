...
public class BluetoothController {
    ...
    public void setUuidHeads(String serviceUuidHead,String notifyUuidHead,String writeUuidHead) {
        mServiceUuid = serviceUuidHead + IBleService.UUID_TAIL;
        mNotifyUuid = notifyUuidHead + IBleService.UUID_TAIL;
        mWriteUuid = writeUuidHead + IBleService.UUID_TAIL;
    }
    ...
    public void setReadUuidHead(String readUuidHead) {
        mReadUuid = readUuidHead + IBleService.UUID_TAIL;
    }
